...
public class Teemodel extends SimState {
	...
	public void start() {
		...
		Logger.getGlobal().info("Simulation started");
	}

	@Override
	public void finish() {
		super.finish();
		Logger.getGlobal().info("Simulation finished");
	}
	...
	public static Champion getChampionInstance(String name, int level) throws NoSuchMethodException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, SecurityException {
		try{
	...
	public static Item getItemInstance(String name) throws InstantiationException, IllegalAccessException {
		try{
